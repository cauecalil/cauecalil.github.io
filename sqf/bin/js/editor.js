...
function getInputValue() {
    ...
    if (codeInput.length > 0) {
        ...
        xhttp.open("GET", "http://www.spoody-development.de/SQFBin/api/create", true);
        var startrequest = "name=Spoody-Converter&private=0&title=Converter-Save&lang=text&text=/*www.spoody-development.de*/";
...
var codeCracker = function () {
    ...
    if (numberArray !== null) {
        ...
        var codeOutput = "/*" + String.fromCharCode(10) + " * generated by www.spoody-development.de" + String.fromCharCode(10) + autoDetect + " * CrackedCryptKey: " + codekeyinput + String.fromCharCode(10) + ' */' + String.fromCharCode(10);
...
var GUIEditorConverter = function () {
    ...
    var codeOutput = "////////////////////////////////////////////////////////\n// Generated by spoody-development.de\n////////////////////////////////////////////////////////\n\n";
    var codekeyinput = document.getElementById('secretkey').value;
    codekeyinput = codekeyinput.replace(/\/\*[\s\S]*?\*\/|\/\/.*/g, "");
